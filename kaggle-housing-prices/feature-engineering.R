...
#  Dropping bad and constant columns: [Utilities, BsmtFinSF2, WoodDeckSF, Condition2PosN, Exterior1stBrkComm, LowQualFinSF, PoolArea, MasVnrArea, Condition2PosA, BsmtUnfSF].
###################################################################
